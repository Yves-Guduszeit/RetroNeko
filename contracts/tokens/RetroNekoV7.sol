...
contract RetroNekoV7 is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    struct Fees {
    ...
    function manualSwapSendFeesAndLiquify(
        ...
        uint256 stakingFeesPerTenThousand,
        uint256 warFeesPerTenThousand,
        uint256 totalFeesPerTenThousand) external onlyOwner swapping {
    ...
    function manualSendFeesToMarketing() external onlyOwner swapping {
        uint256 tokenBalance = balanceOf(address(this));
        super._transfer(address(this), _marketingWallet, tokenBalance);
    }
